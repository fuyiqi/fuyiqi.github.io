...
角色<code>flink-operator</code>职责是管理<code>flinkdeployments</code>、为flink作业创建并管理<code>[JobManager](https://nightlies.apache.org/flink/flink-docs-master/docs/concepts/flink-architecture/#jobmanager)</code>和其他资源（比如说<code>[serivices](https://kubernetes.io/docs/concepts/services-networking/service/)</code>）。
角色<code>flink</code>职责是帮助flink作业的JobManager去创建并管理<code>[TaskManagers](https://nightlies.apache.org/flink/flink-docs-master/docs/concepts/flink-architecture/#taskmanagers)</code>和<code>[ConfigMaps](https://kubernetes.io/docs/concepts/configuration/configmap/)</code>。
