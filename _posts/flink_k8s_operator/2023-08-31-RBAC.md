...
角色<code>flink-operator</code>职责是管理<code>flinkdeployments</code>、为flink作业创建并管理[JobManager](https://nightlies.apache.org/flink/flink-docs-master/docs/concepts/flink-architecture/#jobmanager)和其他资源（比如说[serivices](https://kubernetes.io/docs/concepts/services-networking/service/)）。
